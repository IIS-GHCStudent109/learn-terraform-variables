terraform {
 ...
 #   workspaces {
 #     name = "tf-vault-qa-kbalasun-2026-06-23"
 #   }
 # }
...
module "s3-bucket-kbalasun" {
  source  = "app.terraform.io/policy-as-code-training/s3-bucket-kbalasun/aws"
  version = "1.0.0"
  # insert required variables here
   bucket_name = "s3-bucket-kbalasun-new"
}
